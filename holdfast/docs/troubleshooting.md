...
- [Integration Guide](./integration-guide.md) — SDK setup, PDA derivations, program addresses
- [ElizaOS Integration Guide](./elizaos-integration-guide.md) — plugin setup and configuration
- [Escrow IDL Reference](../../docs/escrow-idl-reference.md) — raw program interaction for advanced use cases
- [Threat Model](./tm_escrow_engine.md) — security analysis and known attack vectors
